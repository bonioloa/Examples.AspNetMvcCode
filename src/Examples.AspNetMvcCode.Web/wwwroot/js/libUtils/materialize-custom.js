...
; (function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '.file-field input[type="file"]', function () {
            ...
            //START edit UF: customized separator, we use a char not allowed in file names, 
            //original is comma and it's no good for our use
            path_input[0].value = file_names.join(SharedConstSite.get('AttachmentMultipleNamesSeparator') + ' ');
            //END custom edit
