...
public class ReportisticaController : BaseContextController
{
    ...
    public IActionResult ReportAvanzatoSalvaLayout(IFormCollection form)
    {
        ...
        try
        {
            _logicDataGrid.SaveView(dataGridViewStateSaveLgc);
            resultCode = "OK";
        ...
        {
            resultCode = "KO";
            message = "Errore durante salvataggio vista griglia";
        }

        //reload saved values to rebuild selection
        HashSet<OptionLgc> dataGridSaveViewSet = _logicDataGrid.GetSavedViews(DataGridViewUsage.ReportAdvanced);
    ...
    {
        DataGridViewStateLgc dataGridViewStateLgc = _logicDataGrid.LoadView(
