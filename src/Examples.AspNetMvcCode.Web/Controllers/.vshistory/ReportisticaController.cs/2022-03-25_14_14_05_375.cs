...
public class ReportisticaController : BaseContextController
{
        ...
        )
    {
        ...
        (
            ...
            , ReportExportViewModel modelWithFilters
                    ...
                    , addLinkedItemsToResultsFilter : WebAppConstants.HtmlValueIncludeLinked //linked always included for normal report
            ...
            )
    {
        ...
        if (addLinkedItemsToResultsFilter.StringHasValue()
            && addLinkedItemsToResultsFilter.EqualsInvariant(WebAppConstants.HtmlValueIncludeLinked))
        {
            addLinkedItemsToResults = true;
        }
