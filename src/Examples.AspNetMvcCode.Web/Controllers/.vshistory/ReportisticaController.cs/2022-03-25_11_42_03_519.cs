...
public class ReportisticaController : BaseContextController
{
        ...
        )
    {
        ...
        (
            ...
            , ReportExportViewModel modelWithFilters
                    ...
                    , addlinkedItemsToResults : WebAppConstants.HtmlValueIncludeLinked //linked always included for normal report
        ...
        )
    {
        ...
        (
           ...
           , ReportExportViewModel modelWithFilters
                   ...
                   , dateExpirationFromFilter: dataScadenzaDa
                   , dateExpirationToFilter: dataScadenzaA
                   , addlinkedItemsToResults: recuperaAncheCollegatiAdElementi
    ...
    private (
        ...
        GetFiltersAndReportDataInner(
            ...
            , string addlinkedItemsToResults
            , string pageTitle
            , string viewName
            )
    {
        ...
        if (addlinkedItemsToResults is null)
        {
            addLinkedItemsToResults = true;
        }
        if (addlinkedItemsToResults.StringHasValue()
            && addlinkedItemsToResults.EqualsInvariant(WebAppConstants.HtmlValueIncludeLinked))
        {
            addLinkedItemsToResults = true;
        }
