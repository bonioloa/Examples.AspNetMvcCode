...
public static class ParamsNames
{
    ...
    //DataGrid (dev express)
    public const string DataGridViewStateSerialized = "salva-stato-griglia-serializzato";
    public const string DataGridViewStateDescription = "salva-stato-griglia-descrizione";
    public const string DataGridViewStateChooseIfSaveIsPersonal = "salva-stato-griglia-personale-profili";
    //public const string DataGridViewStateChooseProfiles = "salva-stato-griglia-profili";
