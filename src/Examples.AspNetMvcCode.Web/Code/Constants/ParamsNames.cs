...
public static class ParamsNames
{
    ...
    //widespread use
    public const string CompanyGroupId = "idSocieta";
    ...
    public const string ItemId = "idElemento";

    //argument in ConsultaEvoluzioneDati
    public const string FormCode = "codiceSchedaPassaggio";
    ...
    public const string DataGridViewStateSerialized = "stato-datagrid";
    public const string DataGridViewStateDescription = "descrizione-stato-datagrid";
    public const string DataGridViewStateChooseIfSaveIsForAllProfiles = "stato-griglia-personale-o-profili";

    //DataGrid (dev express) load view params
    public const string DataGridLoadStateChoose = "caricaStatoGrigliaSelect";
    ...
    public const string ExclusiveRole = "profiloesclusivo";
