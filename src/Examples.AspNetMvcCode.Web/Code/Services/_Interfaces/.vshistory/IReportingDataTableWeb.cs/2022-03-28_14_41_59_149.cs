...
public interface IReportingDataTableWeb
{
    ...
    DataRow MapRowForm(DataRow row, IHtmlContent processDescription, IHtmlContent stepDescription, ItemFormDisplayBasicModel itemForm);
    DataRow MapRowItemBasicData(DataRow row, ReportItemBasicDataModel reportItemInfo, bool omitSuffix, bool hasItemEndEditableField);
}