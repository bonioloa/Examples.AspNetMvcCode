...
public class HtmlFormToModelMapperWeb : IHtmlFormToModelMapperWeb
{
    ...
    private (
        FileAttachmentViewModel attachmentModel
        , string fieldName
        )
        MapUploadedFile(
        ...
        )
    {
        ...
        return (attachmentModel, fieldName);
    }
        ...
        )
    {
        ...
        {
            (tmpAttachment, tmpFieldName) = MapUploadedFile(file, singleSubmission: false);
    ...
    public FileAttachmentViewModel MapItemInsertFromFile(IFormCollection formFileUpload)
    {
        ...
        FileAttachmentViewModel tmpAttachment;
        //string tmpFieldName;
        (tmpAttachment, _) = MapUploadedFile(formFileUpload.Files[0], singleSubmission: true);
