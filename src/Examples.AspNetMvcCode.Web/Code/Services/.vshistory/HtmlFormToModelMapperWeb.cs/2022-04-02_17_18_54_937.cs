...
public class HtmlFormToModelMapperWeb : IHtmlFormToModelMapperWeb
{
        ...
        )
    {
        ...
        if(type == DataGridViewUsage.Unknown)
        {
            _logger.LogAppError($"provide a valid {nameof(DataGridViewUsage)}, provided {type}");
            throw new WebAppException();
        }
        ...
        foreach (string key in form.Keys)
        {
            ...
            switch (tmpKey)
            {
                case ParamsNames.DataGridViewStateSerialized:
