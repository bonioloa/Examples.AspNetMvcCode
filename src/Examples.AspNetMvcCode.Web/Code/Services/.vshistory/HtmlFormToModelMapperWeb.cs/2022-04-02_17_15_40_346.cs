...
public class HtmlFormToModelMapperWeb : IHtmlFormToModelMapperWeb
{
    ...
    public DataGridViewSaveViewModel MapDataGridViewSave(
        ...
        , DataGridViewUsage gridViewUsageType
        )
    {
        _logger.LogAppDebug("CALL");
        ...
        if(gridViewUsageType == DataGridViewUsage.Unknown)
        {
            _logger.LogAppError($"provide a valid {nameof(DataGridViewUsage)}, provided {gridViewUsageType}");
            throw new WebAppException();
        }

        DataGridViewSaveViewModel model = new()
        {
            Type  = gridViewUsageType,
        };
