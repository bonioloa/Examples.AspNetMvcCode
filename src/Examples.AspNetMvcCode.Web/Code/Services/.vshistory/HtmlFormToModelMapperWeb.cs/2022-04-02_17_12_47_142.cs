...
public class HtmlFormToModelMapperWeb : IHtmlFormToModelMapperWeb
{
    ...
    public DataGridViewSaveViewModel MapGridViewSave(
        ...
        , GridViewUsage gridViewUsageType
        )
    {
        _logger.LogAppDebug("CALL");
        ...
        if(gridViewUsageType == GridViewUsage.Unknown)
        {
            _logger.LogAppError($"provide a valid {nameof(GridViewUsage)}, provided {gridViewUsageType}");
            throw new WebAppException();
        }
