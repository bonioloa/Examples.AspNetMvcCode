...
public class ReportingMapperWeb : IReportingMapperWeb
{
        ...
        )
    {
        ...
        foreach(var sheetAreaModel in sheetAreaList)
        {
            tmpDataFound = null;//reset

            if (sheetAreaModel is ReportConfigAreaDataLgc areaData)
            {
            ...
            if (sheetAreaModel is ReportConfigAreaImageLgc areaImage)
            {
            ...
            if (sheetAreaModel is ReportConfigAreaTextLgc areaText)
            {
            ...
            _logger.LogAppError($"unhandled area type {sheetAreaModel.GetType()}");
