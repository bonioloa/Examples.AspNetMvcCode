...
public class ReportingMapperWeb : IReportingMapperWeb
{
        ...
        )
    {
        ...
        //foreach(ReportingAreaModel sheetAreaModel in sheetAreaList)
        {
            tmpDataFound = null;//reset
            //switch(sheetAreaModel.Type)
            //{
            //    case ReportAreaDataToLoad.DocumentInfo:
            //        break;

            //    case ReportAreaDataToLoad.FiltersUsed:
            //        break;

            //    case ReportAreaDataToLoad.DataItemsByProcess:
            //        break;
            //}
            if (sheetArea is ReportConfigAreaDataLgc areaData)
            {
                ...
                {
                    ReportAreaDataToLoad.DataItemsByProcess =>
