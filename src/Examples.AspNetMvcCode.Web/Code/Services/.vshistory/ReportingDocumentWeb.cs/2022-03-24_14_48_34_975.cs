...
public class ReportingDocumentWeb : IReportingDocumentWeb
{
        ...
        )
    {
        ...
        (
            ...
            , IList<ReportPositionGridForMasterProcessModel> gridsByProcessList
                    ...
                    reportDataDumpModel.ReportItemPrimaryInfoList
        ...
        dataToLoad =
            GetItemsStepsData(
                ...
                , gridsByProcessList
                , reportDataDumpModel.ItemFormDataByProcess
        ...
        )
    {
        ...
        if (reportDataDumpModel.ItemFormDataByProcess.IsNullOrEmpty())
        {
            return true;
        }
        ...
        foreach (var pr in reportDataDumpModel.ItemFormDataByProcess)
        {
        ...
        )
    {
        ...
        */
        ...
        ReportingAreaSimpleModel itemsRootMainSchemaModel =
            _webReportingDataTable.GetPrimaryDataTableSchema(
                    isRootGroup: true
                    , reportData.ReportItemPrimaryInfoList
                    , hasItemEndEditableField
                    );
        ...
        Dictionary<long, List<StepFormSchema>> formsSchemasByProcess = 
            GetFormSchemasByProcess(reportData.ItemFormDataByProcess);
        ...
        foreach (long processId in reportData.ReportItemPrimaryInfoList.Select(ri => ri.ProcessId)
                                                                      .Distinct()
                                                                      .OrderBy(pr => pr))
        {
            tmpRootItemsMainData = 
                reportData.ReportItemPrimaryInfoList.Where(ip => ip.ProcessId == processId)
            ...
            if (reportData.ItemFormDataByProcess.HasValues() &&
                reportData.ItemFormDataByProcess.Any(ifp => ifp.ProcessId == processId))
            {
            ...
            if(hasLinked                
                && reportData.ItemFormDataByProcess.HasValues()
                && )
            {
