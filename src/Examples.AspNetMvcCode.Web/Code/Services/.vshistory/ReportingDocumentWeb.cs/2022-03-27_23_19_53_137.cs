        ...
        */
        ...
        foreach (long rootProcessId in reportData.RootProcessIdList)
        {
            ...
            foreach (ReportItemBasicDataModel itemBasicData in tmpItemsBasicDataByRootProcess)
            {
                ...
                {
                    tmpSlaveItemRowCountMax = reportData.ItemsBasicDataList.Where(ps => ps.ProcessId == slaveProcessId
                ...
                //root item must be repeated, slave items not
                for(int index = 0; index< slaveItemRowCount; )
            }
