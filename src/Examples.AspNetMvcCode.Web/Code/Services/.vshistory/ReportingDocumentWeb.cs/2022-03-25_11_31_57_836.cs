...
public class ReportingDocumentWeb : IReportingDocumentWeb
{
        ...
        )
    {
        ...
        dataToLoad =
            GetItemsStepsData(
                ...
                , gridsByProcessList
                , reportDataDumpModel.ItemsFormsByProcess
        ...
        )
    {
        ...
        if (reportDataDumpModel.ItemsFormsByProcess.IsNullOrEmpty())
        {
            return true;
        }
        ...
        foreach (var pr in reportDataDumpModel.ItemsFormsByProcess)
        {
        ...
        )
    {
        ...
        */
        ...
        Dictionary<long, List<StepFormSchema>> formsSchemasByProcess = 
            GetFormSchemasByProcess(reportData.ItemsFormsByProcess);
                                                                      ...
                                                                      .OrderBy(pr => pr))
        {
            ...
            if (reportData.ItemsFormsByProcess.HasValues() &&
                reportData.ItemsFormsByProcess.Any(ifp => ifp.ProcessId == processId))
            {
            ...
            if(hasLinked                
                && reportData.ItemsFormsByProcess.HasValues()
                && )
            {
