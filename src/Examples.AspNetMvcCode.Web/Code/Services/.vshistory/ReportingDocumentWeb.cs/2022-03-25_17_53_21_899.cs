...
public class ReportingDocumentWeb : IReportingDocumentWeb
{
        ...
        )
    {
         ...
         * 
         * colonne dati ITEM ROOT (attenzione che un item ROOT può essere un collegato (sottoprocesso)
         *      Esiste sempre
         *      
