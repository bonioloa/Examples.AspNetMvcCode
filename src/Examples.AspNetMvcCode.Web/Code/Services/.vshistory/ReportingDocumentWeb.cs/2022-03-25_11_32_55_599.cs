...
public class ReportingDocumentWeb : IReportingDocumentWeb
{
        ...
        )
    {
        ...
        (
            ...
            , IList<ReportPositionGridForMasterProcessModel> gridsByProcessList
                    ...
                    reportDataDumpModel.ItemsBaseDataList
        ...
        )
    {
        ...
        */
        ...
        foreach (long processId in reportData.ItemsBaseDataList.Select(ri => ri.ProcessId)
                                                                      .Distinct()
                                                                      .OrderBy(pr => pr))
        {
            tmpRootItemsMainData = 
                reportData.ItemsBaseDataList.Where(ip => ip.ProcessId == processId)
