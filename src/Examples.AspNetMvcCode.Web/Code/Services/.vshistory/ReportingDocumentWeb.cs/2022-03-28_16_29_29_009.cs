...
public class ReportingDocumentWeb : IReportingDocumentWeb
{
        ...
        )
    {
        ...
        */
        ...
        foreach (long rootProcessId in reportData.RootProcessIdList)
        {
            ...
            tmpCompleteAggregate.Data.Columns.Add(new DataColumn()
            {
        ...
        //_logger.LogAppDebug($"{JsonConvert.SerializeObject(completeAggregateDict, Newtonsoft.Json.Formatting.Indented)}");
        ...
        , IList<ItemsFormsByProcessModel> itemFormDataByProcess)
    {
        ...
        //_logger.LogAppDebug($"{JsonConvert.SerializeObject(formsByProcessOutput, Newtonsoft.Json.Formatting.Indented)}");
