...
public class ReportingDataTableWeb : IReportingDataTableWeb
{
        ...
        )
    {
        ...
        {
            ProcessId = processId,
            ColumnsSuffixPrimary = columnGroupName,
            DataColumns = new(),
            ColumnFeatureSet = new(),
        };
        ...
        )
    {
        ...
        string columnGroupName = reportItemInfo.ProcessDescription.GetStringContent();

        string tmpColumnName = FormatColumnNameWithSuffix(_localizer[nameof(LocalizedStr.SharedFieldLabelItemInsertDateTime)], columnGroupName);
        row[tmpColumnName] =
            reportItemInfo.SubmitDateTime.ToStringDateTimeGeneralLong(_contextApp.GetCurrentCulture());
        ...
        )
    {
        ...
        tmpColumnName = FormatColumnNameWithSuffixes(_localizer[nameof(LocalizedStr.SharedFieldLabelFormDateLastEdit)], columnGroupName);
        TestForColumnNameConflict(ref alreadyUsedColumns, tmpColumnName);
        output.DataColumns.Add(
            new DataColumn
            {
        ...
        tmpColumnName = FormatColumnNameWithSuffixes(_localizer[nameof(LocalizedStr.SharedFieldLabelFormUserLastEdit)], columnGroupName);
        TestForColumnNameConflict(ref alreadyUsedColumns, tmpColumnName);
        output.DataColumns.Add(
            new DataColumn
            {
                    ...
                    itemForm.SubmittedInputList.OrderBy(f => f.Progressive))
        {
            ...
            tmpColumnName = FormatColumnNameWithSuffixes(input.Description, columnGroupName);
            TestForColumnNameConflict(ref alreadyUsedColumns, tmpColumnName);
        ...
        )
    {
        ...
        {
            tmpColumnName = FormatColumnNameWithSuffix(submittedInput.Description, columnGroupName);
