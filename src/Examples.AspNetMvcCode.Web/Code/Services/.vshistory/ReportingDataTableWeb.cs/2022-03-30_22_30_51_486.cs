...
public class ReportingDataTableWeb : IReportingDataTableWeb
{
    ...
    public DataTable BuildFileInfoTable(CultureInfo culture, DateTime creationTimestamp)
    {
        ...
        UserBaseInfoLgc userBaseInfo = _logicUserConfigurator.GetCurrentUserData();
        ...
        )
    {
        ...
        tmpDateConversionSuccess = dateSubmitFromStr.TryParseSortableDateInvariantToNullable(out DateTime? dateSubmitFrom);
        ...
        tmpDateConversionSuccess = dateSubmitToStr.TryParseSortableDateInvariantToNullable(out DateTime? dateSubmitTo);
        ...
        {
            tmpDateConversionSuccess = dateExpirationFromStr.TryParseSortableDateInvariantToNullable(out DateTime? dateExpirationFrom);
            ...
            tmpDateConversionSuccess = dateExpirationToStr.TryParseSortableDateInvariantToNullable(out DateTime? dateExpirationTo);
