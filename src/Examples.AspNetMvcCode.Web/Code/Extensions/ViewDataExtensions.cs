...
//To handle null values without repeating code
...
public static class ViewDataExtensions
{
    ...
    public static void SetUseCaptcha(this ViewDataDictionary tempData, bool useCaptcha)
    {
        tempData["UseCaptcha"] = useCaptcha;
    }
    public static bool GetUseCaptcha(this ViewDataDictionary tempData)
    {
        return tempData.GetBool("UseCaptcha");
    }


    public static void SetUseMomentJsLibrary(this ViewDataDictionary tempData, bool useMomentJsLibrary)
    {
        tempData["UseMomentJsLibrary"] = useMomentJsLibrary;
    }
    public static bool GetUseMomentJsLibrary(this ViewDataDictionary tempData)
    {
        return tempData.GetBool("UseMomentJsLibrary");
    }
    ...
    public static void SetUseDevExtremeComponents(this ViewDataDictionary tempData, bool useDevExtremeComponents)
    {
        tempData["UseDevExtremeComponents"] = useDevExtremeComponents;
    }
    public static bool GetUseDevExtremeComponents(this ViewDataDictionary tempData)
    {
        return tempData.GetBool("UseDevExtremeComponents");
    }
    ...
    {
        return
            tempData != null && tempData[key] != null
