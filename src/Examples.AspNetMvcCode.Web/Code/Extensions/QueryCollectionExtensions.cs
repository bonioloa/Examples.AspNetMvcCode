...
public static class QueryCollectionExtensions
{
    public static string GetQueryStringValue(this IQueryCollection querystring, string key)
    {
        return
            ...
            && querystring.TryGetValue(key, out StringValues queryVal)
            && queryVal.HasValues()
    ...
    public static IDictionary<string, string> ToDictionaryApp(this IQueryCollection querystring)
    {
        ...
        temp.Remove(ParamsNames.ReturnUrl.ToLowerInvariant());
        temp.Remove(ParamsNames.ReturnUrl.ToUpperInvariant());
